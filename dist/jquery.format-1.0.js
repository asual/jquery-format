        ...
        return {
                ...
                if (typeof value == 'string') {
                	...
                	while (i < format.length) {
                		...
                		if (token == 'yyyy' || token == 'yy' || token == 'y') {
                            ...
                            for (var j = 0, monthName; monthName = locale.dates.monthsFull[j]; j++) {
                            ...
                            for (var j = 0, monthName; monthName = locale.dates.monthsShort[j]; j++) {
                				if (value.substring(pos, pos + monthName.length).toLowerCase() == monthName.toLowerCase()) {
                                    month = j + 1;
                                    pos += monthName.length;
                                    break;
                			...
                			for (var j = 0, dayName; dayName = locale.dates.daysFull[j]; j++) {
                			...
                			for (var j = 0, dayName; dayName = locale.dates.daysShort[j]; j++) {
                				if (value.substring(pos, pos + dayName.length).toLowerCase() == dayName.toLowerCase()) {
                					pos += dayName.length;
                					break;
                				}
                	...
                	value['MMM'] = locale.dates.monthsShort[M-1];
                	value['MMMM'] = locale.dates.monthsFull[M-1];
                	value['d'] = d;
                	value['dd'] = formatNumber(d);
                	value['EEE'] = locale.dates.daysShort[E];
                	value['EEEE'] = locale.dates.daysFull[E];
                	value['H'] = H;
            ...
            number: function(value, format) {
                ...
                if (typeof value == 'string') {
                    ...
                    var groupingSeparator = locale.numbers.groupingSeparator;
                    var decimalSeparator = locale.numbers.decimalSeparator;        
                    ...
                    if (decimalIndex != -1) {
                        ...
                        var fraction = locale.numbers.decimalSeparator;
                        ...
                        if (fraction == locale.numbers.decimalSeparator) {
                            fraction = '';
                        }
                    }
                    ...
                    if (decimalIndex != 0) {
                        ...
                        var grouping = locale.numbers.groupingSeparator;
                        var groupingSize = 0;
